...
var findBiggestChannel = function findBiggestChannel(rgbValues) {
...
var quantization = function quantization(rgbValues, depth) {
  ...
  var channel = findBiggestChannel(rgbValues);
  rgbValues.sort(function (a, b) {
    return a[channel] - b[channel];
  });
  var mid = rgbValues.length / 2;
  return __spreadArray(__spreadArray([], quantization(rgbValues.slice(0, mid), depth + 1), true), quantization(rgbValues.slice(mid + 1), depth + 1), true);
};
(_a = document.getElementById("btnLoad")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", function () {
  var _a;
  var $$imgFile = document.getElementById("imgfile");
  var image = new Image();
  var file = (_a = $$imgFile === null || $$imgFile === void 0 ? void 0 : $$imgFile.files) === null || _a === void 0 ? void 0 : _a[0];
